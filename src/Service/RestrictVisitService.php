...
namespace Drupal\restrict_visit\Service;

use Drupal\Core\Config\ConfigFactoryInterface;
use Drupal\Core\Path\CurrentPathStack;
use Drupal\Core\Path\PathMatcherInterface;
use Drupal\Core\Session\AccountProxyInterface;
use Drupal\restrict_visit\Mapper\RestrictIpMapperInterface;
use Symfony\Component\HttpFoundation\RequestStack;

class RestrictVisitService implements RestrictVisitServiceInterface
{
	/**
	...
	/**
	 * Constructs a RestrictVisitService object
	 *
